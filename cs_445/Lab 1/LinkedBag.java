...
{
	private Node firstNode, lastNode;       // Reference to first and last node
	...
	public Iterator<T> iterator()
	{
		return new Iterator<T>()
		{
			...
			{
				return numberOfEntries != 0 && currentNode != lastNode;
			}
   ...
   public boolean remove(T anEntry)
	...
	public BagInterface<T> union(BagInterface<T> anotherBag)
    {
		...
		for(Object t : (LinkedBag)anotherBag)
		{
			result.add((T)t);
		}
        return result;
